...
from modeling.new_rcnn import supNewGeneralizedRCNN
...
outname = 'Full_supervision_Shape2Mask'  ## dir-name
cuda_id = "0" # gpu_num
os.environ["OMP_NUM_THREADS"] = "1"
os.environ["MKL_NUM_THREADS"] = "1"

# Runtime configuration
config_file = 'configs/metal-InstanceSegmentation/BoxSnake_RCNN/sup_shape2point_R_50_FPN_1x.yaml'
...
META_ARCH_REGISTRY.register(supNewGeneralizedRCNN)
...
def trans_cfg(cfg):
    ...
    cfg.MODEL.BOX_SUP.LOSS_GLOBAL_PAIRWISE = cfg_GLOBAL_PAIRWISE
    ...
    cfg.DATALOADER.NUM_WORKERS = 1 # 改回0 lmc
