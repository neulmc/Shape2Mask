...
__all__ = ["rawNewGeneralizedRCNN"]


@META_ARCH_REGISTRY.register()
class rawNewGeneralizedRCNN(GeneralizedRCNN):
    """
    ...
    def __init__(
        ...
        """
        super(rawNewGeneralizedRCNN, self).__init__(backbone=backbone, proposal_generator=proposal_generator,
                                                 roi_heads=roi_heads,
    ...
    def inference(
        ...
        if do_postprocess:
            ...
            return rawNewGeneralizedRCNN._postprocess(results, batched_inputs, images.image_sizes)
        else:
            return results
    ...
    def _postprocess(instances, batched_inputs: List[Dict[str, torch.Tensor]], image_sizes):
        ...
        for results_per_image, input_per_image, image_size in zip(
            ...
            r = detector_postprocess(results_per_image, height, width, head_nums=0)
