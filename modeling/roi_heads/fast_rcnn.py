...
__all__ = ["fast_rcnn_inference", "size_FastRCNNOutputLayers"]
...
class size_FastRCNNOutputLayers(nn.Module):
    """
    ...
    def __init__(
        ...
        *,
        ...
        if self.size_input:
            self.cls_score = nn.Linear(input_size + 4, num_classes + 1)
    ...
    @classmethod
    def from_config(cls, cfg, input_shape, size_input):
        return {
            "input_shape": input_shape,
            "size_input": size_input, # lmc
            ...
            "loss_weight"               : {"loss_cls":cfg.MODEL.ROI_BOX_HEAD.BBOX_CLS_LOSS_WEIGHT,
                                           "loss_box_reg": cfg.MODEL.ROI_BOX_HEAD.BBOX_REG_LOSS_WEIGHT},  # noqa
    ...
    def predict_boxes_for_gt_classes(self, predictions, proposals):
        ...
        return predict_boxes.split(num_prop_per_image), scores.split(num_prop_per_image)
